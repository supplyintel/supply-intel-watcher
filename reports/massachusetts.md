...
- **Treatment providers:** 2 relevant item(s) for human review.
- **Harm reduction:** 1 relevant item(s) for human review.
- **Law enforcement:** 2 relevant item(s) for human review.

## Geographic safeguard

An external watchlist item does not establish detection, availability, exposure, overdose involvement, or risk in Massachusetts. Confirm Massachusetts-specific evidence before making a local claim or recommendation.
